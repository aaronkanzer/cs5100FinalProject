...
with open('/Users/AaronKanzer/Desktop/FinalProject-CS5100/cs5100FinalProject/train.csv') as csv_file:
...
with open('/Users/AaronKanzer/Desktop/FinalProject-CS5100/cs5100FinalProject/test.csv') as csv_file:
    csv_reader = csv.reader(csv_file, delimiter=',')
    line_count = 0
    for row in csv_reader:
        if line_count > 0:
